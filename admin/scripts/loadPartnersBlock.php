<div class="row">
	<?php 
		...
		$selectPartners = mysqli_query($link, "SELECT * FROM in_images WHERE type = 'partner'");
		...
		<div class="col-lg-4">                            
			<div class="card">
				...
				<div class="card-body"> 
					<div class="media">
						<img src="/admin/uploads/partners/<?php echo $getPartner['image'] ?>" alt="" class="img-thumbnail">
					</div>
				</div><!--end card-body-->
			</div><!--end card-->
		</div>
