            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title-box">
                                <div class="row">
                                    <div class="col">
                                        <h4 class="page-title">Тарифы Coach</h4>
					...
					<?php
						if(isset($_GET['addNewTariff']))
						{
							...
							if($error == 0){
								...
								$insert = mysqli_query($link, "INSERT INTO in_tariffs (name,hints,month,half_year,year,type) VALUES ('$name','$hints','$month','$half_year','$year','coach')");
					...
					<div class="col-lg-12">
						...
						<?php
							$select = mysqli_query($link, "SELECT * FROM in_tariffs WHERE type = 'coach'");
