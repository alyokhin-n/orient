    ...
    <body class="dark-sidenav">
        ...
        <div class="page-wrapper">
            ...
            <div class="page-content">
                <div class="container-fluid">
                                ...
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <!-- <a style="position: absolute;right: 0px;top: -8px;" href="?add=1&page=<?php echo $_GET['page'] ?>" class="btn btn-success waves-effect waves-light">
											...
											Добавить</a> -->
										<button id="savePercentKoef" class="btn btn-primary waves-effect waves-light" style="float: right;margin-right: 10px;display: none;"><i class="fas fa-save"></i></button>
										<input id="percentKoef" type="number" name="" class="form-control" placeholder="<?php echo $get_percent_coach['value']; ?>" value="<?php echo $get_percent_coach['value']; ?>" style="width: 80px;float: right;margin-right: 10px;margin-left: 10px;">
										<h5 style="float: right;margin: 0px;padding: 0px;line-height: 0;">Коэффициент:</h5>
										<button type="button" class="btn btn-success waves-effect waves-light excelButtonPaid" style="float: right;margin-right: 120px;margin-top: -17px;" data-toggle="modal" data-target="#exampleModalExcel"><i class="far fa-file-excel"></i> Загрузить Excel с выплатами</button>
					...
					<?php 
						if (isset($_GET['saveEditUser']))	
						{
							...
							if ($error == 0)
							{
								$update = "UPDATE in_clients SET email = '$email', paysera_address = '$paysera_address' WHERE id = '$id'";
					...
					<div class="col-lg-12">
						...
						<div class="card">
							...
							<div class="card-body">
								...
								<form id="searchForm" method="get" action="/admin/scripts/coach_datatable2.php">
									<div class="row">
										...
										<div class="col-lg-2">
											<div class="form-group">
												<label data-toggle="tooltip" data-placement="top" title="Маршруты - установленные цена >0 (кол-во)">ɌƧF</label>
												<div style="display: flex;">
													<div class="input-group" style="margin-right: 5px;">
														<span class="input-group-prepend">
															<button type="button" class="btn btn-secondary">ОТ</button>
														</span>
														<input type="number" id="search_count_cost_not_null_with" name="search_count_cost_not_null_with" class="form-control search-class">
													</div>
													<div class="input-group" style="margin-left: 5px;">
														<span class="input-group-prepend">
															<button type="button" class="btn btn-secondary">ДО</button>
														</span>
														<input type="number" id="search_count_cost_not_null_to" name="search_count_cost_not_null_to" class="form-control search-class">
													</div>
												</div>
											</div>
										</div>
										...
										<div class="col-lg-2">
											<div class="form-group">
												<label data-toggle="tooltip" data-placement="top" title="Маршруты - установленные цена =0 (кол-во)">ɌƧP</label>
												<div style="display: flex;">
													<div class="input-group" style="margin-right: 5px;">
														<span class="input-group-prepend">
															<button type="button" class="btn btn-secondary">ОТ</button>
														</span>
														<input type="number" id="search_count_cost_null_with" name="search_count_cost_null_with" class="form-control search-class">
													</div>
													<div class="input-group" style="margin-left: 5px;">
														<span class="input-group-prepend">
															<button type="button" class="btn btn-secondary">ДО</button>
														</span>
														<input type="number" id="search_count_cost_null_to" name="search_count_cost_null_to" class="form-control search-class">
													</div>
												</div>
											</div>
										</div>
										...
										<div class="col-lg-2">
											<div class="form-group">
												<label data-toggle="tooltip" data-placement="top" title="Полученная сумма - маршруты">∑ƧM</label>
												<div style="display: flex;">
													<div class="input-group" style="margin-right: 5px;">
														<span class="input-group-prepend">
															<button type="button" class="btn btn-secondary">ОТ</button>
														</span>
														<input type="number" id="search_all_route_price_with" name="search_all_route_price_with" class="form-control search-class">
													</div>
													<div class="input-group" style="margin-left: 5px;">
														<span class="input-group-prepend">
															<button type="button" class="btn btn-secondary">ДО</button>
														</span>
														<input type="number" id="search_all_route_price_to" name="search_all_route_price_to" class="form-control search-class">
													</div>
												</div>
											</div>
										</div>
										...
										<div class="col-lg-2">
											<div class="form-group">
												<label data-toggle="tooltip" data-placement="top" title="Полученная сумма - чаевые">∑ƧT</label>
												<div style="display: flex;">
													<div class="input-group" style="margin-right: 5px;">
														<span class="input-group-prepend">
															<button type="button" class="btn btn-secondary">ОТ</button>
														</span>
														<input type="number" id="search_all_route_tips_with" name="search_all_route_tips_with" class="form-control search-class">
													</div>
													<div class="input-group" style="margin-left: 5px;">
														<span class="input-group-prepend">
															<button type="button" class="btn btn-secondary">ДО</button>
														</span>
														<input type="number" id="search_all_route_tips_to" name="search_all_route_tips_to" class="form-control search-class">
													</div>
												</div>
											</div>
										</div>
										...
										<div class="col-lg-2">
											<div class="form-group">
												<label data-toggle="tooltip" data-placement="top" title="Процент чаевых от суммы за платные маршруты">%ТƧ</label>
												<div style="display: flex;">
													<div class="input-group" style="margin-right: 5px;">
														<span class="input-group-prepend">
															<button type="button" class="btn btn-secondary">ОТ</button>
										...
										<div class="col-lg-2">
											<div class="form-group">
												<label data-toggle="tooltip" data-placement="top" title="Полученная сумма - подсказки">∑ƧH</label>
												<div style="display: flex;">
													<div class="input-group" style="margin-right: 5px;">
														<span class="input-group-prepend">
															<button type="button" class="btn btn-secondary">ОТ</button>
														</span>
														<input type="number" id="search_all_route_hints_with" name="search_all_route_hints_with" class="form-control search-class">
													</div>
													<div class="input-group" style="margin-left: 5px;">
														<span class="input-group-prepend">
															<button type="button" class="btn btn-secondary">ДО</button>
														</span>
														<input type="number" id="search_all_route_hints_to" name="search_all_route_hints_to" class="form-control search-class">
													</div>
												</div>
											</div>
										</div>
										...
										<div class="col-lg-2">
											<div class="form-group">
												<label data-toggle="tooltip" data-placement="top" title="Полученная сумма - маршруты + чаевые + подсказки">∑ƧS</label>
												<div style="display: flex;">
													<div class="input-group" style="margin-right: 5px;">
														<span class="input-group-prepend">
															<button type="button" class="btn btn-secondary">ОТ</button>
														</span>
														<input type="number" id="search_all_route_sum_with" name="search_all_route_sum_with" class="form-control search-class">
													</div>
													<div class="input-group" style="margin-left: 5px;">
														<span class="input-group-prepend">
															<button type="button" class="btn btn-secondary">ДО</button>
														</span>
														<input type="number" id="search_all_route_sum_to" name="search_all_route_sum_to" class="form-control search-class">
													</div>
												</div>
											</div>
										</div>
										...
										<div class="col-lg-2">
											<div class="form-group">
												<label data-toggle="tooltip" data-placement="top" title="Начисленная сумма - оплаченная">∑Pd</label>
												<div style="display: flex;">
													<div class="input-group" style="margin-right: 5px;">
														<span class="input-group-prepend">
															<button type="button" class="btn btn-secondary">ОТ</button>
														</span>
														<input type="number" id="search_pay_sum_with" name="search_pay_sum_with" class="form-control search-class">
													</div>
													<div class="input-group" style="margin-left: 5px;">
														<span class="input-group-prepend">
															<button type="button" class="btn btn-secondary">ДО</button>
														</span>
														<input type="number" id="search_pay_sum_to" name="search_pay_sum_to" class="form-control search-class">
													</div>
												</div>
											</div>
										</div>
										...
										<div class="col-lg-2">
											<div class="form-group">
												<label data-toggle="tooltip" data-placement="top" title="Начисленная сумма - не оплаченная">∑tP</label>
												<div style="display: flex;">
													<div class="input-group" style="margin-right: 5px;">
														<span class="input-group-prepend">
															<button type="button" class="btn btn-secondary">ОТ</button>
														</span>
														<input type="number" id="search_no_pay_sum_with" name="search_no_pay_sum_with" class="form-control search-class">
													</div>
													<div class="input-group" style="margin-left: 5px;">
														<span class="input-group-prepend">
															<button type="button" class="btn btn-secondary">ДО</button>
														</span>
														<input type="number" id="search_no_pay_sum_to" name="search_no_pay_sum_to" class="form-control search-class">
													</div>
												</div>
											</div>
										</div>
										...
										<div class="col-lg-2">
											<div class="form-group">
												<label data-toggle="tooltip" data-placement="top" title="Сумма тренеру - оплаченная + не оплаченная">∑Ƨ</label>
												<div style="display: flex;">
													<div class="input-group" style="margin-right: 5px;">
														<span class="input-group-prepend">
															<button type="button" class="btn btn-secondary">ОТ</button>
										...
										<div class="col-lg-2">
											<div class="form-group">
												<label data-toggle="tooltip" data-placement="top" title="Маршруты - признаны BAD (кол-во)">ɌƧB</label>
												<div style="display: flex;">
													<div class="input-group" style="margin-right: 5px;">
														<span class="input-group-prepend">
															<button type="button" class="btn btn-secondary">ОТ</button>
										...
										<div class="col-lg-2">
											<div class="form-group">
												<label data-toggle="tooltip" data-placement="top" title="Маршруты - средний рейтинг (без BAD)">ɌƧR</label>
												<div style="display: flex;">
													<div class="input-group" style="margin-right: 5px;">
														<span class="input-group-prepend">
															<button type="button" class="btn btn-secondary">ОТ</button>
										...
										<div class="col-lg-2">
											<div class="form-group">
												<label data-toggle="tooltip" data-placement="top" title="Дата крайней оплаты тренеру">LastPd</label>
												<div class="input-group">                                            
													<input type="text" class="form-control search-class" name="search_last_pay_date">
													<div class="input-group-append">
														<span class="input-group-text"><i class="dripicons-calendar"></i></span>
													</div>
												</div>
										...
										<div class="col-lg-2">
											<div class="form-group">
												<label data-toggle="tooltip" data-placement="top" title="Дата установки первого маршрута">1ɌƧ</label>
												<div class="input-group">                                            
										...
										<div class="col-lg-2">
											<div class="form-group">
												...
												<button type="button" class="btn btn-success waves-effect waves-light excelButton" data-toggle="tooltip" data-placement="top" title="Выгрузить в Excel оплаты" style="margin-top: 8px;"><i class="far fa-file-excel"></i></button>
												<button type="button" class="btn btn-warning waves-effect waves-light exportexcel" data-toggle="tooltip" data-placement="top" title="Выгрузить в Excel" style="margin-top: 8px;"><i class="far fa-file-excel"></i></button>
								...
								<script>
									$( ".exportexcel" ).click(function() {
										...
										var url = "scripts/export_coachs.php?" + $form.serialize();
									...
									$(".excelButton").click(function(){
										...
										var url = "scripts/coach_to_xls.php?" + $form.serialize();
										window.open(url, '_blank');
									});
								</script>
						...
						<table id="coachTable" class="table table-striped table-bordered dt-responsive" style="width:100%">
							<thead>
								<tr>
									<th data-name="nikname">Ник</th>
									<th data-name="paysera_address">IDPay</th>
									<th data-name="country">Страна</th>
									<th data-name="region">Регион</th>
									<th data-name="profit_sum" data-toggle="tooltip" data-placement="top" title="Сумма - прибыль">∑ƧɌ</th>
									<th data-name="count_cost_not_null" data-toggle="tooltip" data-placement="top" title="Маршруты - установленные цена >0 (кол-во)">ɌƧF</th>
									<th data-name="count_cost_null" data-toggle="tooltip" data-placement="top" title="Маршруты - установленные цена =0 (кол-во)">ɌƧP</th>
									<th data-name="all_route_price" data-toggle="tooltip" data-placement="top" title="Полученная сумма - маршруты">∑ƧM</th>
									<th data-name="all_route_tips" data-toggle="tooltip" data-placement="top" title="Полученная сумма - чаевые">∑ƧT</th>
									<th data-name="procent_tips" data-toggle="tooltip" data-placement="top" title="Процент чаевых от суммы за платные маршруты">%ТƧ</th>
									<th data-name="all_route_hints" data-toggle="tooltip" data-placement="top" title="Полученная сумма - подсказки">∑ƧH</th>
									<th data-name="all_route_sum" data-toggle="tooltip" data-placement="top" title="Полученная сумма - маршруты + чаевые + подсказки">∑ƧS</th>
									<th data-name="pay_sum" data-toggle="tooltip" data-placement="top" title="Начисленная сумма - оплаченная">∑Pd</th>
									<th data-name="no_pay_sum" data-toggle="tooltip" data-placement="top" title="Начисленная сумма - не оплаченная">∑tP</th>
									<th data-name="all_sum" data-toggle="tooltip" data-placement="top" title="Сумма тренеру - оплаченная + не оплаченная">∑Ƨ</th>
									<th data-name="route_bad" data-toggle="tooltip" data-placement="top" title="Маршруты - признаны BAD (кол-во)">ɌƧB</th>
									<th data-name="avg_rate" data-toggle="tooltip" data-placement="top" title="Маршруты - средний рейтинг (без BAD)">ɌƧR</th>
									<th data-name="last_pay_date" data-toggle="tooltip" data-placement="top" title="Дата крайней оплаты тренеру">LastPd</th>
									<th data-name="first_date_route" data-toggle="tooltip" data-placement="top" title="Дата установки первого маршрута">1ɌƧ</th>
				...
				<div class="modal fade" id="exampleModalExcel" tabindex="-1" role="dialog" aria-labelledby="exampleModalExcel" aria-hidden="true">
					<div class="modal-dialog" role="document">
						<div class="modal-content">
							<div class="modal-header bg-warning">
								<h6 class="modal-title m-0 text-white" id="exampleModalExcel">Загрузить Excel с выплатами</h6>
								<button type="button" class="close " data-dismiss="modal" aria-label="Close">
									<span aria-hidden="true"><i class="la la-times text-white"></i></span>
								</button>
							</div>
							<div class="loadedContent">
								<div class="modal-body">
									<div class="row">
										<div class="col-lg-12">
											<div class="form-group">
												<label for="fp-range">Excel с выплатами</label>
												<input id="defaultInput" class="form-control filetoupload" type="file" required>
											</div>
										</div>
									</div> 
								</div>
								<div class="modal-footer">
									...
									<button class="btn btn-warning btn-sm uploadExcelFile">Загрузить</button>
								</div>
							</div>
						</div>
					</div>
		...
		<script>
			$(document).ready(function() {
				...
				$('#coachTable').DataTable({
					...
					// "serverMethod": 'post',
					"ajax": {
						"url": "/admin/scripts/coach_datatable2.php",
						"type": "POST",
						"dataSrc":"data"
					},
					// "columns": [
					...
					"drawCallback": function( settings ) {
						...
						$( ".delban" ).click(function() {
							...
							$.post( "scripts/confirmation.php", { type: "clientban", id: id }).done(function( data ) {
								$('#coachTable').DataTable().ajax.reload();
			...
			$(document).ready(function(){
				...
				$("#percentKoef").change(function(){
					$("#savePercentKoef").show();
				});

				$("#savePercentKoef").click(function(){
					var value = $("#percentKoef").val();

					$.post( "scripts/save_coach_percent.php", { value: value })
					.done(function( data ) {
						if(data == 1){
							$("#percentKoef").val(value);
							$("#savePercentKoef").hide();
							Command: toastr["success"]("Коэффициент изменен!")
							toastr.options = {
								"closeButton": false,
								"debug": false,
								"newestOnTop": false,
				...
				$("#searchForm").on("submit", function(event){
					...
					$('#coachTable').DataTable().ajax.url(url + "?" + $form.serialize()).load();
				});
				...
				$(".uploadExcelFile").click(function(){
					...
					if(file_data != ''){
						...
						$.ajax({
							url: 'scripts/uploadCoachsPaid.php',
							dataType: 'text',
							cache: false,
							contentType: false,
							processData: false,
							...
							success: function(response){
								if(response == 0){
									...
									$('#coachTable').DataTable().ajax.reload();
									Command: toastr["success"]("Данные загружены. Изменения вступят в силу в течении 1-3 минут")
				...
				$(".changeTemplateBtn").click(function(){
					$.post( "scripts/load_filters_template.php", { type: "coach" })
					.done(function( data ) {
				...
				$(".completeSaveTemplate").click(function(){
					...
					if(name_template != ''){
						...
						if(error == 1){
							$.post( "scripts/add_filters_template.php", { type: "coach", name: name_template, filters: filters })
							.done(function( data ) {
								if(data == 1){
